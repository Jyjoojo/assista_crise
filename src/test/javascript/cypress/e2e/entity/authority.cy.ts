...
describe('Authority e2e test', () => {
  ...
  let username: string;
  let password: string;
  const authoritySample = { name: 'eed75f16-accd-4db3-b854-95295221d8f5' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('236350f0-a29d-4475-9c4e-a25bbda7f34d');
      cy.get(`[data-cy="name"]`).should('have.value', '236350f0-a29d-4475-9c4e-a25bbda7f34d');
