...
const requireRestSample: RestUtilisateur = {
  ...
  dateBannissement: sampleWithRequiredData.dateBannissement?.toJSON(),
};
...
describe('Utilisateur Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Utilisateur', () => {
      ...
      service.create(utilisateur).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a Utilisateur', () => {
      ...
      service.update(utilisateur).subscribe(resp => (expectedResult = resp));
    ...
    describe('addUtilisateurToCollectionIfMissing', () => {
      it('should add a Utilisateur to an empty array', () => {
        ...
        expect(expectedResult).toEqual([utilisateur]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([utilisateur, utilisateur2]);
      });
