...
describe('Utilisateur Management Component', () => {
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: 2179 }], { headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' } });
  ...
  describe('trackId', () => {
    it('should forward to utilisateurService', () => {
      ...
      vitest.spyOn(service, 'getUtilisateurIdentifier');
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.utilisateursParams()).toMatchObject(expect.objectContaining({ sort: ['id,desc'] }));
  });
