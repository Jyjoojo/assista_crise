...
describe('Crise Management Component', () => {
  ...
  let comp: Crise;
  let fixture: ComponentFixture<Crise>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(Crise);
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: 11332 }], { headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' } });
  ...
  describe('trackId', () => {
    it('should forward to criseService', () => {
      ...
      vitest.spyOn(service, 'getCriseIdentifier');
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.crisesParams()).toMatchObject(expect.objectContaining({ sort: ['id,desc'] }));
  });
